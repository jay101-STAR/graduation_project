...
`define DATARAM_INIT_ADDR 12'd544
...
`define MUL_TYPE    8'b00100111
`define MULH_TYPE   8'b00101000
`define MULHSU_TYPE 8'b00101001 
`define MULHU_TYPE  8'b00101010 
`define DIV_TYPE    8'b00101011 
`define DIVU_TYPE   8'b00101100
`define REM_TYPE    8'b00101101 
`define REMU_TYPE   8'b00101110
...
// 乘除指令
`define MUL_INST    3'b000 
`define MULH_INST   3'b001 
`define MULHSU_INST 3'b010 
`define MULHU_INST  3'b011 
`define DIV_INST    3'b100
`define DIVU_INST   3'b101
`define REM_INST    3'b110
`define REMU_INST   3'b111
