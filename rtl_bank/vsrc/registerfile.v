...
module registerfile #(
  ...
  assign rs1_rdata = (rs1_ren && (rs1_raddr != 0)) ? ((waddr == rs1_raddr) ? wdata : rf[rs1_raddr]) : 32'b0;
  assign rs2_rdata = (rs2_ren && (rs2_raddr != 0)) ? ((waddr == rs2_raddr) ? wdata : rf[rs2_raddr]) : 32'b0;
  /* always@(*)begin */
