...
srcHBSelect "testbench.top" -win $_nTrace1
srcHBSelect "testbench.top.u_core" -win $_nTrace1
srcHBSelect "testbench.top.u_core" -win $_nTrace1
srcHBSelect "testbench.top.u_core" -win $_nTrace1
srcSetScope -win $_nTrace1 "testbench.top.u_core" -delim "."
srcHBSelect "testbench.top.u_core" -win $_nTrace1
srcHBSelect "testbench.top.u_core.registerfile0" -win $_nTrace1
srcSetScope -win $_nTrace1 "testbench.top.u_core.registerfile0" -delim "."
srcHBSelect "testbench.top.u_core.registerfile0" -win $_nTrace1
srcHBSelect "testbench.top.u_core.registerfile0.i0" -win $_nTrace1
srcSetScope -win $_nTrace1 "testbench.top.u_core.registerfile0.i0" -delim "."
srcHBSelect "testbench.top.u_core.registerfile0.i0" -win $_nTrace1
srcSignalViewSelect "testbench.top.u_core.registerfile0.i0.rf\[31:0\]"
